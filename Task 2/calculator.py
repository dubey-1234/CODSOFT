...
Image_icon=PhotoImage(file="E:\CODSOFT PYTHON INTENSHIP\Task2\logo.png")
root.iconphoto(False, Image_icon)

Label_result= Label(root,width=25,height=2,text="",font=("arial",30),bg="#a1c9d4")
Label_result.pack()

Button(root,text="C", width=5, height=1, font=("arial",30,"bold"), bd=1,fg="#fff",bg="#2b66f0",command=lambda: clear()).place(x=10,y=100)
...
Button(root,text="=", width=5, height=3, font=("arial",30,"bold"), bd=1,fg="#fff",bg="#ff601c",command=lambda: calculate()).place(x=430,y=400)
